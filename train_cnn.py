...
#'C:/GDM/CNN_train.pkl'
#parser.add_argument('save_path', metavar = 'C:/GDM/_DUT/Машинне навчання та обробка даних в IoT_ Тушич/LK_1/CNN_train.pkl', help='name of file to save parameters in.')
